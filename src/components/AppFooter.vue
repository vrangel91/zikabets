<template>
  <footer class="app-footer">
    <div class="footer-content">
      <div class="footer-section">
        <div class="footer-logo">
          <h3>ZIKABET</h3>
          <p>A plataforma Nº1 de apostas para Dota 1</p>
        </div>
      </div>
      <div class="footer-section">
        ...
        <ul class="footer-links">
          <li>
            <RouterLink to="/games">Partidas ao Vivo</RouterLink>
          </li>
          <li>
            <RouterLink to="/bets">Seu Histórico</RouterLink>
          </li>
          <li>
            <RouterLink to="/dashboard">Dashboard</RouterLink>
          </li>
          <li>
            <RouterLink to="/championship">Campeonato</RouterLink>
          </li>
        </ul>
      </div>
      <div class="footer-section">
        ...
        <ul class="footer-links">
          <li><a href="#" @click.prevent>Termos de Uso</a></li>
          <li><a href="#" @click.prevent>Política de Privacidade</a></li>
          <li><a href="#" @click.prevent>Regras de Apostas</a></li>
        </ul>
      </div>
      <div class="footer-section">
        ...
        <ul class="footer-links">
          ...
          <li><a href="mailto:suporte@zikabet.com">E-mail</a></li>
        </ul>
    ...
    <div class="footer-bottom">
      <p>&copy; 2024 ZIKABET. Todos os direitos reservados.</p>
    </div>
  </footer>
</template>
